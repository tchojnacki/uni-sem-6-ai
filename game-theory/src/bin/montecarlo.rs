...
fn main() {
    ...
    calculate_ratings(
        ...
        &[
            ...
            &AlphaBeta::new(Heuristic::W_VAISHU_MUTHU, 4),
    ...
    calculate_ratings(
        ...
        &[
            ...
            &AlphaBeta::new(Heuristic::le051(), 4),
            &AlphaBeta::new(Heuristic::le064(), 4),
            &AlphaBeta::new(Heuristic::le148(), 4),
            &AlphaBeta::new(Heuristic::le162(), 4),
            &AlphaBeta::new(Heuristic::le215(), 4),
        ],
