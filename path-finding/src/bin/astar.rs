use path_finding::{
    astar_buses, astar_dist, astar_time, dijkstra_time, display, read_line, BusNetwork,
    StopHeuristic, Time,
};
...
fn main() {
    ...
    let criteria = read_line("Podaj kryterium optymalizacyjne [t/p/d/dt]: ");
    ...
    match criteria.as_str() {
        ...
        "dt" => display(dijkstra_time(&bn, &start_name, start_time, &end_name)),
